...
const HomePage = () => {
  ...
  return (
    <div className=" px-5 w-100 text-white ">
      {weather ? (
        <div className="w-100 d-flex justify-content-between ">
          <div className="d-flex flex-column " style={{ lineHeight: "7rem" }}>
            <h1 className="ps-5 pt-3" style={{ textWrap: "nowrap" }}>
              {weather.name}
            </h1>
          ...
          <div className="w-50 d-flex align-items-end flex-column pt-3">
            <p className="fs-4 pe-5">{new Date().toDateString()}</p>
            <h1 className="pe-5" style={{ fontSize: "4.5rem" }}>
              {Math.floor(weather.main.temp)}
              <sup>&deg;c</sup>
            </h1>
            <div className=" w-100 pt-2 d-flex flex-column align-items-end pe-5">
